    ...
    >
      <defs>
        <linearGradient id="vc-flow-grad" x1="0" y1="0" x2="1" y2="0">
          ...
          <stop offset="0.55" stopColor="#30cfff" />
          <stop offset="1" stopColor="#30cfff" />
        </linearGradient>
      ...
      <path d={d} stroke="#30cfff" strokeOpacity={0.16} strokeWidth={7} strokeLinecap="round" filter="url(#vc-line-glow)" />

      {/* static base conduit — always physically touches both anchors */}
      <path d={d} stroke="#30cfff" strokeOpacity={0.45} strokeWidth={2} strokeLinecap="round" />
      ...
      <circle cx={geo.ex} cy={geo.ey} r={3} fill="#30cfff" stroke="#fff" strokeWidth={1.5} />
