...
const PANELS: Panel[] = [
  ...
  },
  {
    ...
    body: "Human-in-the-loop by default: nothing Vera writes sends without your sign-off. You get full reply visibility, so every conversation lands in one place and no warm lead slips through.",
