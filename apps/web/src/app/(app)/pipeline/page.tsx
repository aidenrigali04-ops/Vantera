...
export default async function PipelinePage() {
  ...
  const nameById = new Map((leadRows ?? []).map((l) => [l.id, l.company_name || l.first_name || "A lead"]));
  ...
  const goalLabel = account.revenue_goal_cents
    ? usd.format(account.revenue_goal_cents / 100)
    : null;
