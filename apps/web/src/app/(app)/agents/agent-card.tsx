              ...
              <form action={switchMode} ref={modeFormRef}>
                ...
                {automatic ? (
                  ...
                  <ConfirmDialog
                    ...
                    description="Clean drafts go out on their own within your safety limits. Anything the humanizer flags still waits for you in Review. You can switch back anytime."
