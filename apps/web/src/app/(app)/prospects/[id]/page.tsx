  ...
  switch (l.status) {
    ...
    default:
      return {
        ...
        description: "Your outreach layer writes a personalized message and queues it in Approvals.",
      };
  }
}
        ...
        <div className="mt-3 flex flex-wrap items-end justify-between gap-x-8 gap-y-4">
          ...
          <div className={cn(PANEL_SURFACE, "flex shrink-0 items-stretch px-5 py-4")}>
            <div className={cn(proj && "pr-6")}>
              ...
              {/* R2: an archived/filtered lead keeps its score but never the live "Hot prospect"
                  framing — "Archived" and "Hot prospect" side by side read as a contradiction. */}
              <p
                className={cn(
                  "mt-0.5 text-xs",
