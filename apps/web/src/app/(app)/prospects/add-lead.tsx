...
/**
 * R6: "Add prospect" — the user brings their own prospect. The dialog collects identity only;
  ...
  const submit = (fd: FormData) => {
    ...
    addManualLead(fd)
      .then((res) => {
        ...
        toast.success("Prospect added — Vera is researching and scoring them now.");
