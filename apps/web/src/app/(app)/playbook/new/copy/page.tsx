      ...
      <Panel className="mx-auto flex max-w-xl flex-col gap-4 border-dashed">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-muted-foreground">
            The Outreach Agent writes to the prospects your Prospect Agent finds — without one, it
            has no one to write to.
          </p>
        </div>
        <Button asChild className="w-fit">
          <Link href="/playbook/new/scout">Set up your Prospect Agent</Link>
        </Button>
      </Panel>
    );
  }
