import type { ApolloPersonResult, ICPConfig, ICPScoreResult } from '@/lib/aspire/types'
...
function scoreContactQuality(person: ApolloPersonResult): { points: number; signals: string[] } {
  let points = 0
...
function scoreTechBonus(person: ApolloPersonResult, config: ICPConfig): { points: number; signals: string[] } {
...
export function scoreICP(person: ApolloPersonResult, config: ICPConfig): ICPScoreResult {
