...
export const ONBOARDING_WIZARD_SLIDES: OnboardingWizardSlide[] = [
  ...
  },
  {
    ...
    body: 'We mapped your industry and target buyers. Review the summary, then confirm who you sell to.',
  ...
  },
  {
    ...
    body: 'Review and refine your ICP — industry, company size, roles, and pain points. This powers Aspire prospecting and outreach.',
