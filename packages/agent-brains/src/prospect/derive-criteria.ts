...
const DERIVE_SYSTEM = registerPrompt("prospect/derive-criteria", `You turn a seller's free-text ideal-customer description into LinkedIn people-search filters. You receive a seller context block and the ICP description; emit reasoning first (one dense sentence deciding who the human buyer is), then the filter arrays.
