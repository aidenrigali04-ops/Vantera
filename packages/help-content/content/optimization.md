...
Every touch moves through four stages, and each has a conversion rate:

1. **Connection acceptance** — invites sent → accepted.
2. **Reply rate** — accepted connections → interested replies.
3. **Booking rate** — interested replies → meetings booked.
