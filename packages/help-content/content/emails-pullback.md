...
Real names from your own account — the buyers Vera matched against your ICP, or the people your
drafted messages are addressed to — plus how many are waiting in total. If there's nothing real to
name, no email is sent.

## Turning it off

**Settings → Notifications** has a toggle for lifecycle emails, and every one of these emails also
carries a one-click unsubscribe link that works without signing in. Following it opts you out of
lifecycle email for every workspace you're an owner or admin on, not just the one that sent it —
you can turn it back on per workspace from Settings → Notifications at any time.
