...
Each lead carries a fit verdict at a glance — Hot lead, Strong fit, or Worth a look — based on its score, so you can spot the best prospects without reading every number.

**Hot right now** sits at the top of the page: your strongest-fit leads, pulled out of the list so you can work the best opportunities first. The table gives every lead its own **Why now** column — a real buying signal captured during enrichment (a funding round, an executive hire, a new office, a product launch, or active buying intent) when we have one, otherwise the AI's read on the lead's top trigger or pain. A real, dated signal always wins, because it's the difference between a guess and insider timing. When a lead has replied but the reply has been sitting for a few days, it's marked **cooling** in the same column so a warm conversation never quietly goes cold. On wider screens you'll also see **Worth** — what closing that lead means toward your revenue goal — and **Last activity**, the most recent thing that happened (a reply, a research pass, or sourcing).

You can **search** the list by name, company, or title, and narrow it with **Filters** — industry, minimum score, when the lead was sourced, or in-market only. Sort by **Score**, **Company**, or **Last activity** (click a column header; click again to go back to newest first), choose how many leads show per page (10, 25, or 50), and jump straight to any page. The table also remembers your comfortable/compact row-density choice.

To work many leads at once, tick the **checkboxes** and use the bulk bar: **Archive** stops outreach to the selected leads and cancels their queued drafts (history kept), and **Suppress** permanently adds them to your never-contact list — both ask you to confirm first.
