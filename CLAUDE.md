...
# HubSpot CLI — CRM connection setup (added 2026-06-14)

> HubSpot is a CRM provider for the Phase 9 CRM-push connection. The HubSpot CLI
> initialized a project here (`hsproject.json` at repo root); the guidance below is
> auto-generated for working with HubSpot components.
